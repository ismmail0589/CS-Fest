<body>
  ...
  ?>
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                ...
                <p>Register Fees is very affordable.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                <h3 class="heading mb-3">Students Loves</h3>
                <p>Students love our events and participate.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                <h3 class="heading mb-3">Best Events</h3>
                <p>We manage best events.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                <h3 class="heading mb-3">Our Management Team</h3>
                <p>Our management team is very skillfull.</p>
              </div>
            </div>      
          </div>
        </div>
    		...
    		<div class="row">
    			<div class="col-md-12">
    				<div class="single-slider owl-carousel ftco-animate">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/cs_image.png);">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/PUBG_Mobile.png);">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/programming.jpg);">
                                 ...
                                 while($row = mysqli_fetch_array($run_query2)){
                                   ...
                                   <div class='destination'>
                                     ...
                                     <div class='text p-3'>
                                       ...
                                       <p>Participate in event and enjoy</p>
                                       <hr>
                                       <p class='bottom-area d-flex'>
                                         <span><i class='icon-map-o'></i> Hassan, Bilal</span> 
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/pic.jpg);">
    	<div class="container">
      ...
      <div class="container">
        <div class="row justify-content-start">
          <div class="col-md-5 heading-section ftco-animate">
            ...
            <p>We provide our best event in a affordable prices so that every student can participate.</p>
		            ...
		            <div class="carousel-testimony owl-carousel">
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Hasnain Iqbal has joined Department of Computer Science, COMSATS University Islamabad, Pakistan as Research Associate. He has 7 years of work experience in academics as well as in industry. His research interest includes Information Systems, Requirements Engineering, Software Architecture, Product Quality Models, Requirements Gathering, Requirements Analysis, and Decision Support Systems.</p>
		                    <p class="name">Hasnain Iqbal</p>
		              ...
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Dr. Majid Iqbal Khan is currently working as Professor in the Department of Computer Science at COMSATS University Islamabad. His research interest includes Trust management in distributed systems, Realtime task scheduling in networks, Routing issues in internet of things. Dr. Majid obtained his Masters degree in Software Engineering (2004) and a PhD in Wireless Sensor Networks from University of Vienna, Austria in 2009. </p>
		                    <p class="name">Dr. Majid Iqbal Khan</p>
