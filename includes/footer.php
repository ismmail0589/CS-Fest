        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">CS </h2>
              <p>The Department of CS will create high quality professionals in Computer Science and to foster leading edge research and to equip students to succeed and contribute to industry and society.</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text"> hostel city, M524+PJP Line 12, Park Rd, Islamabad, Pakistan. </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">(051) 9247000</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">cs2k23@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
